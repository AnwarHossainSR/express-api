...
export const PARTICIPANTS_ROLE = ['Producer', 'Actor', 'Director', 'Musician', 'Writer'];
export const MOVIE_GENRE = ['Action', 'Comedy', 'Drama', 'Fantasy', 'Horror', 'Mystery', 'Romance', 'Thriller'];
